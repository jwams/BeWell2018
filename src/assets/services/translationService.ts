			...
			switch(page) {
				...
				case "LifeSpeak": {
					return {
						...
						mainParagraph2: "",
						mainParagraph2AriaLabel: "",
						mainParagraphLinkContent: "Access LifeSpeak now",
						mainParagraphLink: "http://www.google.com",
						mainParagraphLinkContentAriaLabel: "Access LifeSpeak button",
						bulletPointHeader: "",
						bulletPointHeaderAriaLabel: "",
						bulletPoint1: "",
						bulletPoint1AriaLabel: "",
						bulletPoint2: "",
						bulletPoint2AriaLabel: "",
						bulletPoint2SubPoint1: "",
						bulletPoint2SubPoint1AriaLabel: "",
						bulletPoint2SubPoint2: "",
						bulletPoint2SubPoint2AriaLabel: "",
						...
						bulletPoint7: "",
						bulletPoint7AriaLabel: "",
						secondListTitle: "Once on the home page, enter “Canada” in the Corporate ID space, insert Correctional Service of Canada, and then select the forward arrow to get started.",
						secondListTitleAriaLabel: "",
						secondListMainParagraph: "",
						secondListMainParagraphAriaLabel: "",
						secondListBulletPoint1: "",
			...
			switch(page) {
				...
				case "CrisisReferralCentre": {
					return {
						...
						bulletPointHeaderAriaLabel: "Bullet Point Header",
						bulletPoint1: "des services confidentiels de soutien et de counseling immédiats par téléphone en cas de crise;",
						bulletPoint1AriaLabel: "Bullet Point 1",
						...
						bulletPoint2SubPoint3: "",
						bulletPoint2SubPoint3AriaLabel: "",
						bulletPoint3: "un aiguillage possible vers des services de counseling à court terme.",
						bulletPoint3AriaLabel: "Bullet Point 3",
						bulletPoint4: "",
						bulletPoint4AriaLabel: "",
						bulletPoint5: "",
						...
						secondListMainParagraphAriaLabel: "Avantages pour la famille summary",
				...
				case "LifeSpeak": {
					return {
						title: "LifeSpeak",
						callnowText: "",
						mainParagraph: "LifeSpeak est un service Web qui offre une plateforme de « mieux-être total » pour vous aider à être présent, productif et heureux au travail et dans la vie. Il comprend plus de 260 courtes vidéos présentées par des experts de premier plan sur divers sujets comme l’anxiété, la nutrition, les dépendances et les relations. Vous y trouverez régulièrement des fiches-conseils, des stratégies pratiques et de nouvelles campagnes de contenu. Il est anonyme et peut être consulté de n’importe où, à n’importe quel moment, sur n’importe quel appareil avec une connexion Internet. ",
						mainParagraphAriaLabel: "LifeSpeak Summary",
						mainParagraph2: "",
						mainParagraph2AriaLabel: "",
						mainParagraphLinkContent: "Accéder à LifeSpeak maintenant",
						mainParagraphLink: "http://www.google.com",
						mainParagraphLinkContentAriaLabel: "Access LifeSpeak button",
						bulletPointHeader: "",
						bulletPointHeaderAriaLabel: "",
						...
						bulletPoint7: "",
						bulletPoint7AriaLabel: "",
						secondListTitle: "Une fois sur la page d’accueil, entrez « Canada » dans l’espace réservé à l’identification de la Société, insérez Service correctionnel Canada, puis sélectionnez la flèche avant pour commencer.",
						secondListTitleAriaLabel: "",
						secondListMainParagraph: "",
						secondListMainParagraphAriaLabel: "",
						secondListBulletPoint1: "",
